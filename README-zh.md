...
- [PRD 到 Coding 的文档编排](.codex/modules/PRD-Pipeline/docs/PRD-to-Coding-Orchestration.md)
- [PRD-Pipeline 调用接口](.codex/modules/PRD-Pipeline/docs/PRD-Pipeline-Interface.md)
- [文档系统任务计划](.codex/modules/PRD-Pipeline/docs/todo-plan.md)
...
2. 结合 `docs/PRD.md`、`docs/Workflow.md` 与 `.codex/modules/PRD-Pipeline/docs/` 中的编排文档理解目标文档链路。
3. 使用 `.codex/modules/PRD-Pipeline/` 下的可复用资产：
...
5. 如果你希望整条文档流水线自动跑到最后，并支持 checkpoint 恢复，使用 `/prd-pipeline`。
...
1. 遵循 `.codex/modules/PRD-Pipeline/rules/` 中的规则。
