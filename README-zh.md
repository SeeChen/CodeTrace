...
2. 结合 `docs/PRD.md`、`docs/Workflow.md` 与 `.claude/docs/` 中的编排文档理解目标文档链路。
3. 使用 `.claude/` 下的可复用资产：
   ...
   - `memory/`：稳定的项目上下文
   - `docs/`：内部编排与计划文档
1. 按阶段生成 `specs/ref/`、`specs/global/`、`specs/domains/`、`specs/testing/` 与 `specs/acceptance/`。
2. 如果你希望整条文档流水线自动跑到最后，并支持 checkpoint 恢复，使用 `/prd-pipeline`。
