---
name: coding-agent
description: Stage 4 of the PRD pipeline. Implements code and tests from frozen build-spec task slices without silently redesigning the system.
---
...
4. `.claude/memory/implementation-log.md`
